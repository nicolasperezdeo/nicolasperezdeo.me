      ...
      <div className="relative mx-auto flex max-w-6xl flex-col gap-12 px-6 lg:flex-row lg:items-center">
        ...
        >
          ...
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm uppercase tracking-widest text-black/70">Currently in</p>
              <p className="mt-1 flex items-center gap-2 text-lg font-semibold text-black">
                <HiMapPin className="h-5 w-5 text-black/70" />
                {profile.location}
              </p>
            </div>
            <div className="rounded-full border border-[#FBF4BD]/60 bg-white/70 px-4 py-2 text-xs font-semibold uppercase tracking-[0.35em] text-black/70 shadow-sm backdrop-blur-md">
          ...
          <dl className="mt-10 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <dd className="mt-2 text-3xl font-semibold text-black">NLP and Computer Vision</dd>
              <p className="mt-2 text-sm text-black/70">
                From healthcare to diverse production use cases
              </p>
            </div>
          </dl>
        </motion.div>
